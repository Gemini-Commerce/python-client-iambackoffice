...
class TestIambackofficeLoginResponse(unittest.TestCase):
    """IambackofficeLoginResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IambackofficeLoginResponse:
        """Test IambackofficeLoginResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IambackofficeLoginResponse`
        """
        model = IambackofficeLoginResponse()
        if include_optional:
    ...
    def testIambackofficeLoginResponse(self):
        """Test IambackofficeLoginResponse"""
