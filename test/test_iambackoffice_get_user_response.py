...
class TestIambackofficeGetUserResponse(unittest.TestCase):
    """IambackofficeGetUserResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IambackofficeGetUserResponse:
        """Test IambackofficeGetUserResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IambackofficeGetUserResponse`
        """
        model = IambackofficeGetUserResponse()
        if include_optional:
    ...
    def testIambackofficeGetUserResponse(self):
        """Test IambackofficeGetUserResponse"""
