...
class TestIambackofficeRegistrationResponse(unittest.TestCase):
    """IambackofficeRegistrationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IambackofficeRegistrationResponse:
        """Test IambackofficeRegistrationResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IambackofficeRegistrationResponse`
        """
        model = IambackofficeRegistrationResponse()
        if include_optional:
    ...
    def testIambackofficeRegistrationResponse(self):
        """Test IambackofficeRegistrationResponse"""
