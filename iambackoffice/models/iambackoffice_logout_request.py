...
class IambackofficeLogoutRequest(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of IambackofficeLogoutRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of IambackofficeLogoutRequest from a dict"""
        if obj is None:
            return None
