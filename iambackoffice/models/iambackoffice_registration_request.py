...
class IambackofficeRegistrationRequest(BaseModel):
    ...
    send_set_password_email: Optional[StrictBool] = Field(default=None, alias="sendSetPasswordEmail")
    skip_registration_verification: Optional[StrictBool] = Field(default=None, alias="skipRegistrationVerification")
